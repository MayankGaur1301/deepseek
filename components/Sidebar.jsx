...
const Sidebar = ({ expand, setExpand }) => {
  ...
  const {user} = useAppContext() // user data for profile picture of user
  ...
  return (
    ...
    >
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <div
              className={`absolute w-max text-white text-xs px-2 py-1 bg-black rounded shadow transform ${
                expand ? "left-1/2 -translate-x-1/2 top-12" : "-top-10 left-0"
      ...
      <div>
        ...
        >
          {
            user? <UserButton /> : <Image src={assets.profile_icon} alt="user profile" className="w-7" />
          }
